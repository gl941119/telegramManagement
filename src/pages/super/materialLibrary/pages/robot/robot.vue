    ...
    <el-dialog :title="dialogType=='add' ?'添加机器人':'编辑机器人'" :visible.sync="robotDialog" width="400px">
      <el-form :model="robotForm" ref="ruleForm">
        <el-form-item label="bot name" prop="name"  :label-width="formLabelWidth">
          <el-input v-model="robotForm.botId" disabled style="width: 200px;float: left"></el-input>
        </el-form-item>
        <el-form-item label="bot名称" prop="crowd"  :label-width="formLabelWidth">
          <el-input v-model="robotForm.botName" disabled style="width: 200px;float: left"></el-input>
        </el-form-item>
        <el-form-item label="入群打招呼设置" prop="crowd"   :label-width="formLabelWidth">
          <el-input v-model="robotForm.helloSet" disabled style="width: 200px;float: left"></el-input>
        </el-form-item>
        <el-form-item label="所属群" prop="crowd"  :label-width="formLabelWidth">
          <el-input v-model="robotForm.belongGroup" disabled style="width: 200px;float: left"></el-input>
        </el-form-item>
        <el-form-item label="所属账号" prop="crowd"  :label-width="formLabelWidth">
          <el-input v-model="robotForm.belongAccount" disabled style="width: 200px;float: left"></el-input>
        </el-form-item>
        <el-form-item label="秘钥" prop="crowd"  :label-width="formLabelWidth">
          <el-input v-model="robotForm.secretKey" disabled style="width: 200px;float: left"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="robotDialog = false">取 消</el-button>
        <el-button type="primary" @click="robotDialog = false" >确定</el-button>
    ...
    <el-table :data="tableData" ref="multipleTable" style="width: 100%"
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="text" @click="editDialog(scope.row)">查看</el-button>
        </template>
      </el-table-column>
    </el-table>
