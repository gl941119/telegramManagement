    ...
    <el-dialog title="编辑" :visible.sync="dialogFormVisible" width="500px">
      <el-form :model="form">
        <el-form-item label="群名称:" :label-width="formLabelWidth">
          <el-input v-model="form.groupTitle" auto-complete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="群公告:" :label-width="formLabelWidth">
          <el-input type="textarea"
                    :rows="2" v-model="form.groupNotice" auto-complete="off"></el-input>
        </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //跳转群用户
      lookGroupUser(row){
        this.$router.push({name:'lookGroupUser',params:{groupId:row.groupId}})
      }
    },
