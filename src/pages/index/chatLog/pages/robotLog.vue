<template>
  <el-card class="box-card">
    ...
    <dialog-clearlog style="float: right;margin-bottom: 20px" :status="'robot'" @RequestData="RequestData"></dialog-clearlog>
    <!--消息-->
    <el-alert
      :title="alertMessage"
      type="info"
    ...
    <el-table :data="tableData" ref="multipleTable" style="width: 100%"
      ...
      <el-table-column prop="corpusType" label="响应功能类型">
        <template slot-scope="scope">
          <p>聊天对话</p>
        </template>
      </el-table-column>
      <el-table-column prop="userTitle" label="用户名"></el-table-column>
      <el-table-column prop="phone" label="手机号"></el-table-column>
      <el-table-column prop="replyTime" label="创建时间"></el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button type="text">优化语料库</el-button>
        </template>
      </el-table-column>
